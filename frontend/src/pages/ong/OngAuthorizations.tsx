...
import { CURRENT_ONG_ID, mockOngs } from '../../data/mock-ongs';
import { formatDate, formatDateTime } from '../../utils/format';
import { materialMeta, requestStatusMeta, severityMeta } from '../../utils/labels';
import type { AuthorizationRequest, MaterialKey } from '../../types';
...
export function OngAuthorizationsPage() {
  const { perimeters, requests, submitRequest } = useEcomer();
  const ong = mockOngs.find((o) => o.id === CURRENT_ONG_ID)!;
  ...
  const mine = requests.filter((r) => r.ongId === CURRENT_ONG_ID);
